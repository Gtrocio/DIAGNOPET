  ...
  <div class="container">
    ...
    <script>
      function acceptTerms() {
        ...
        // Add logic to proceed, e.g., window.location.href = '/dashboard';
      }
      function declineTerms() {
        alert('Terms declined. You will be redirected.');
        // Add logic to decline, e.g., window.location.href = '/';
      }
    </script>
  </div>
</body>
